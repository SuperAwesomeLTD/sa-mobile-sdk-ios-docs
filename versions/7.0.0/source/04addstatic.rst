...
You can download the latest `SuperAwesomeSDK-<sdk_version>.iOS.full.lib.zip <https://github.com/SuperAwesomeLTD/sa-sdk-build-repo/blob/master/package/aa_ios/<sdk_version>/SuperAwesomeSDK-<sdk_version>.iOS.full.lib.zip?raw=true>`_ file - which contains the **libSuperAwesomeSDK.a** and
